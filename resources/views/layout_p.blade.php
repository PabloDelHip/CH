...
<script type="text/javascript">
        $(document).ready(function() {
            ...
            OpenPay.setApiKey('pk_bea3100e9a0a4517b93bf979fa3ab2ca');
			...
			<div class="row justify-content-end d-flex align-items-start">
				<div class="datos header">
					<span >
						...
						<a style="color: #fff;" target="_blank" href="https://www.facebook.com/cundoit/"><img style="border: solid 1px #fff; width: 20px;" src="{{ url('img/m-face.jpg') }}"> ¡Siguenos!</a>
					</span>
				</div>
				<div class="datos-header">
					...
					<span >
						...
						<a  href="https://api.whatsapp.com/send?phone=5219982121612&text=Buen dia, estoy interesado en unos tours" target="_blank"><img src="{{ url('img/wp.png') }}" style="width: 20px;"> Contactos aqui</a>
					</span>
...
{{-- 				<div class="datos-header">
				...
				<div>
					...
					<div class="moneda d-flex align-items-center text-left" text-decoration: none;"><a href="{{ url('en/') }}"><img class="mr-1"  src="{{ url('/img/bandera-usa.png') }}" alt="bandera de mexico"></a></div>
			    </div>
			</div>
		</div>
		...
		<div class="container ver-movil ocultar">
			<div class="row d-flex align-items-center">
				...
				<div class="col-auto menu-derecha-movil">
					...
					<a href="https://api.whatsapp.com/send?phone=5219982121612&text=Buen dia, estoy interesado en unos tours" target="_blank"><i class="icon-whatsapp" aria-hidden="true"></i></a>
				</div>
			</div>
		</div>
	</header>
						...
						<a class="navbar-brand" href="{{ url('/') }}">
					 	 ...
					 	 <div class="collapse navbar-collapse menu {{ (Request::path() != '/') ? 'home' : '' }}" id="navbarSupportedContent">
					    	...
					    	<ul class="nav navbar-nav pull-xs-right">
					    		<li class="nav-item">
					        		<a style="color: #3a3a3a;" class="nav-link" href="{{ url('/') }}">INICIO <span class="sr-only">(current)</span></a>
					      		</li>
					      		<li class="nav-item">
					        		<a style="color: #3a3a3a;" class="nav-link" href="{{ url('nosotros') }}">NOSOTROS <span class="sr-only">(current)</span></a>
					      		</li>
					      		...
					      		{{-- <li class="nav-item dropdown">
					        		<a class="nav-link dropdown-toggle" style="color: #3a3a3a;" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					         		TOURS
					        		</a>
						        	<div class="dropdown-menu sub-menu" aria-labelledby="navbarDropdown">
						          		
										<a style="color: #3a3a3a;" class="dropdown-item" href="{{route("categories",['categorie'=> 'sitios-arqueologicos'])}}">ARQUEOLÓGICOS</a>
					        			<a style="color: #3a3a3a;" class="dropdown-item" href="{{route("categories",['categorie'=> 'acuaticos'])}}">ACUATICOS</a>
						        	</div>
					      		</li> --}}
                                <li class="nav-item">
                                    <a style="color: #3a3a3a;" class="nav-link" href="{{route("categories",['categorie'=> 'sitios-arqueologicos'])}}">ARQUEOLÓGICOS</a>
                                </li>
                                <li class="nav-item">
                                    <a style="color: #3a3a3a;" class="nav-link" href="{{route("categories",['categorie'=> 'acuaticos'])}}">ACUATICOS</a>
                                </li>
					      		<li class="nav-item">
					        		<a style="color: #3a3a3a;" class="nav-link" href="{{route("transportacionGet")}}">TRANSPORTACIÓN</a>
					      		</li>
					      		<!-- <li class="nav-item">
					        		<a style="color: #3a3a3a;" class="nav-link" href="{{route("cars")}}">RENTA DE AUTOS</a>
					      		</li> -->
					      		<li class="nav-item">
					        		<a style="color: #3a3a3a;" class="nav-link" href="{{route("yates")}}">YATES</a>
					      		</li>
					      		{{-- <li class="nav-item">
					        		<a class="nav-link" href="{{route("categories",['categorie'=> 'acuaticos'])}}">ACUATICOS</a>
					      		</li> --}}
                                <li class="nav-item">
                                    <a style="color: #3a3a3a;" class="nav-link" href="{{route("categories",['categorie'=> 'ventura-park'])}}">VENTURA PARK</a>
                                </li>
					      		<li class="nav-item">
					        		<a style="color: #3a3a3a;" class="nav-link" href="{{route("categories",['categorie'=> 'experiencias-xcaret'])}}">PARQUES XCARET</a>
					      		</li>
                                <li class="nav-item">
                                    <a style="color: #3a3a3a;" class="nav-link" href="{{route("categories",['categorie'=> 'delfines-cancun'])}}">DELFINES</a>
                                </li>
                                <li class="nav-item">
                                    <a style="color: #3a3a3a;" class="nav-link" href="{{route("categories",['categorie'=> 'selvatica'])}}">SELVATICA</a>
                                </li>
					      		
					      		<li class="nav-item">
					        		<a style="color: #3a3a3a;" class="nav-link" href="{{route("categories",['categorie'=> 'capitan-hook'])}}">CAPTAIN HOOK</a>
					      		</li>
					      		{{-- <li class="nav-item">
					        		<a style="color: #3a3a3a;" class="nav-link" href="{{route("departamentos")}}">DEPARTAMENTOS</a>
					      		</li> --}}
					      		{{-- <li class="nav-item">
					        		<a style="color: #3a3a3a;" class="nav-link" href="{{route("categories",['categorie'=> 'sitios-arqueologicos'])}}">ARQUEOLÓGICOS</a>
					      		</li>
								...
								{{-- <li class="nav-item">
					        		...
					        		<a style="color: #ea2e2e;     font-size: 1.6em; margin-top: -5px;" class="nav-link" href="{{route("ofertas")}}"> <i class="fas fa-gift"></i> OFERTAS</a>
					      		</li> --}}
							    ...
							    <li class="nav-item">
							        <a style="color: #3a3a3a;" class="nav-link" href="{{ url('/carrito') }}">
							        	<i class="icon-basket"></i>
							        	<span id="num-items" class="p-0 m-0">{{Cart::content()->count()}}</span>
							        </a>
							    </li>
	...
	<!-- FINAL NAV -->
			...
			<nav id="menu-movil" style="z-index: 1000;">
				<ul>
                    ...
                    {{-- <li class="nav-item"><a href="{{route("departamentos")}}">DEPARTAMENTOS</a></li> --}}
                    {{-- a style="color: #666;" class="nav-link" href="{{route("departamentos")}}">DEPARTAMENTOS</a> --}}
					
					<!-- <li class="nav-item"><a  href="{{route("cars")}}">RENTA DE AUTOS</a></li> -->
					<li class="nav-item"><a  href="{{route("yates")}}">YATES</a></li>

					     <li class="nav-item">
					        		<a  href="{{route

                                        ("categories",['categorie'=> 'sitios-arqueologicos'])}}">ARQUEOLÓGICOS</a>
					      		</li>
                                <li class="nav-item">
                                    <a href="{{route("categories",['categorie'=> 'acuaticos'])}}">ACUATICOS</a>
                                </li>
					<li class="nav-item">
					        <a href="{{route("categories",['categorie'=> 'experiencias-xcaret'])}}">PARQUES XCARET</a>
					  </li>
                       <li class="nav-item">
                            <a href="{{route("categories",['categorie'=> 'delfines-cancun'])}}">Delfines</a>
                      </li>
                      <li class="nav-item">
                            <a href="{{route("categories",['categorie'=> 'ventura-park'])}}">Ventura Park</a>
                      </li>
                      <li class="nav-item">
                            <a href="{{route("categories",['categorie'=> 'selvatica'])}}">Selvatica</a>
                      </li>
					      		
					      		<li class="nav-item">
					        		<a href="{{route("categories",['categorie'=> 'capitan-hook'])}}">CAPTAIN HOOK</a>
					      		</li>
					      	
					      		
					      		{{-- <li class="nav-item">
					      			<a href="{{route("ofertas")}}"> <i class="fas fa-gift"></i> OFERTAS</a>
					      		</li> --}}
	...
	<footer>
		<div class="footer mt-4 pt-3">
			...
			<div class="row justify-content-center">
				<div class="col-9 text-left mt-3 menu-footer">
					<ul class="lista-footer">
                        ...
                        <a href="{{route("categories",['categorie'=> 'selvatica'])}}">
                            <li>Selvatica</li>
                        </a>
                        <a href="{{route("categories",['categorie'=> 'ventura-park'])}}">
                            <li>Ventura Park</li>
                        </a>
                        <a href="{{route("categories",['categorie'=> 'delfines-cancun'])}}">
                            <li>Delfines</li>
                        </a>

                        
						<a href="{{route("categories",['categorie'=> 'experiencias-xcaret'])}}">
							<li>Parques Xcaret</li>
						</a>
			...
			<div class="row p-0 m-0">
				<div class="col-12 text-center">
					<p class="p-0 m-0 copy">&copy; Todos los derechos reservados Cancún Doit 2018</p>
				</div>
			</div>
		</div>
	</footer>
