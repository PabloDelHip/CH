...
<div class="contenedor-transporte">
	...
	<div style="    position: absolute;
    z-index: 300;
    width: 100%; margin-top: -250px;"> {{-- 176 --}}
		<div class="container">
			<div class="row d-lg-flex justify-content-center">
				<div class="col-9 mt-3">
					<div class="card" style="background-color: rgba(255, 255, 255, 0.8);">
					  <h5 class="card-header text-center" style="background-color: #064983; color: #fff;"><span style="font-weight: 600;">Traslados</span> <i class="fas fa-bus"></i></h5>
					  <div class="card-body">
					    <form class="row" action="{{ route('transportacion') }}" method="POST">
				                        {{ csrf_field() }}
				...
				$("#template-desc").easyAutocomplete(options);
									  ...
									  <div class="form-group col-4">
									   ...
									   <div class="form-group col-4">
				                    	...
				                    	<div class="form-group col-4" id="fechaSalida">
				                        	<label class="mb-0" for="FechaTour">Salida:</label>
...
<div class="container mt-5">
				<div class="row">
					<div class="col-md-5 col-12 text-left titulo">
							...
							<p style="font-size: 1.2em;">En Transfer Cancún Do It ofrecemos transportación a Cancún y la Riviera Maya en tours privados para los turistas. Nuestra prioridad es ofrecer un servicio de calidad y un trato excelente para que los visitantes se sientan como en casa.</p>
