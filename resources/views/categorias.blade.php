...
<div class="container">
                    ...
                    <div class="card contenedor-servicio" style="border: none; ">
                        ...
                        <img class="card-img-top" src="{{ url('img/tours/') }}/{{$tour->image}}" alt="Card image cap"></a>
                            <div class="card-body" style="border:1px solid #ddd; border-radius: 3px; min-height: 169px;">
                                ...
                                @if($tour->xperiencias==0)
                                    <p class="contenedor-servicio-precio m-0" style="font-family: 'Open Sans Condensed', sans-serif !important;">Por persona: ${{ $tour->adult_discount_price }} <span>usd</span></p>
                                    @if ($tour->child_discount_price !=0)
                                        <p style="font-family: 'Open Sans Condensed', sans-serif !important;">por niño: <span style="    color: #37b721; font-weight: bold; font-size: 1.2rem;">${{$tour->child_discount_price}} usd</span></p>
                                    @endif
                                @else
                                <p>{{ $tour->description }}</p>
                                <a href="{{ $tour->url }}" class="btn btn-success btn-sm">Reservar</a>
                                @endif
                                

                                {{-- <p class="contenedor-servicio-precio m-0" style="font-family: 'Open Sans Condensed', sans-serif !important;">Tour Desde: ${{ $tour->adult_price }} <span>usd </span></p> --}}
    ...
    @if(Request::path()=='capitan-hook/categoria')
