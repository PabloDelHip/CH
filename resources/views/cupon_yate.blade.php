...
<div style="text-align: center;">
	...
	<div style="margin-top: 20px;" >
		 ...
		 <br>
		 <br>
		 <span style="font-size: .8em;">TOTAL (100 %): <b>${{$datos_tour_cupon['pago_real']}}</b>usd</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="font-size: .8em;">30% PAGADO: <b>${{$datos_tour_cupon['total_sale']}}</b>usd</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: .8em;">PENDIENTE DE PAGO / PAGAR AL ABORDAR: <b> $@php echo $datos_tour_cupon['pago_real'] - $datos_tour_cupon['total_sale'] @endphp</b> <small>La agencia se comunicará usted al celular que dejó registrado, para agendar y coordinar el pago del 70% restando y el muelle en el que será el servicio.</small></span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: .8em;">COSTO HR. EXTRA: <b>${{$datos_tour_cupon['hora_extra']}}</b></span>
		 <br>
		 <br>
