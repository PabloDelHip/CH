...
<div class="container" style="padding: 10px 5px; background: url(img/fodon_cancundoit.png) no-repeat center center fixed;">
...
<div class="container mt-5">
						...
						<div class="col-md-12 mb-3">
							<div class="card contenedor-servicio" style="border: none; ">
							  ...
							  <div class="card-body" style="border:1px solid #ddd; border-radius: 3px;">
							    ...
							    <a href="#" class="btn btn-success btn-sm mt-3 btn-block">Ver mas</a>
							    {{-- <a href="javascript:void(0)" class="btn btn-primary btn-sm  mt-3" data-toggle="modal" data-target="#trasladosAeropuerto" style="border-radius: 20px;">Ver mas</a> --}}
							  </div>
							</div>
						</div>
    ...
    <div class="slides-container"> --}}
      {{-- <img src="img/p6.png" alt="Cinelli"> --}}
						...
						<div class="col-md-3 mb-4">
							<div class="card contenedor-servicio" style="border: none; ">
							  ...
							  <div class="card-body" style="border:1px solid #ddd; border-radius: 3px;">
							    ...
							    <p class="contenedor-servicio-precio m-0" style="font-family: 'Open Sans Condensed', sans-serif !important;">Desde $499 <span>mxn</span></p>
...
{
	location.href ="https://www.cancundoit.com/";
}
