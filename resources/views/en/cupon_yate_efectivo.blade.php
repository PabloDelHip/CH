...
<div style="text-align: center;">
	...
	<div style="margin-top: 20px;" >
		 ...
		 <br>
		 <br>
		 <span style="font-size: .8em;">TARIFA CONTRATADA: <b>${{$datos_tour_cupon['total_sale']}}</b> mxn</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: .8em;">Pago del 70% restante al abordar: <b> $@php echo $datos_tour_cupon['pago_real'] - $datos_tour_cupon['total_sale'] @endphp</b> <small>La agencia se comunicará usted al celular que dejó registrado, para agendar y coordinar el pago del 70% restando y el muelle en el que será el servicio.</small></span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: .8em;">COSTO HR. EXTRA: <b>${{$datos_tour_cupon['hora_extra']}}</b></span>
		 <br>
		 <br>
