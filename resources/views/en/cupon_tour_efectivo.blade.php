...
acreditar la precontratación del servicio.</p>
    <br>
    <span style="font-size: 1.1em; color: #003A80; font-weight: 300">TOUR - {{$datos_tour_cupon['name']}}</span>
    <p style="color: #636363; font-weight: 300; font-size: .8em;">El servicio de transporte en el TOUR se hace en camioneta con permiso de autotransporte federal de turismo con la capacidad mínimo
...
<p style="color: #636363; font-weight: 300; font-size: .8em;">Las tarifas y cargos informados corresponden al TOUR solicitado y a la moneda nacional.</p>
