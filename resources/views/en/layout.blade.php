			...
			<div class="row justify-content-end d-flex align-items-start">
				<div class="datos header">
					<span >
						...
						<a style="color: #fff;" target="_blank" href="https://www.facebook.com/cundoit/"><img style="border: solid 1px #fff; width: 20px;" src="{{ url('img/m-face.jpg') }}"> Facebook!</a>
					</span>
				</div>
				<div class="datos-header">
					...
					<span>
						...
						<a  href="https://api.whatsapp.com/send?phone=5219982575754&text=Buen dia, estoy interesado en unos tours" target="_blank"><img src="{{ url('img/wp.png') }}" style="width: 20px;"> contact us here!</a>
					</span>
				</div>
{{-- 				<div class="datos-header">
				...
				<div>
					...
					<div class="moneda d-flex align-items-center text-left" text-decoration: none;"><a href="{{ url('/') }}"><img class="mr-1"  src="{{ url('/img/bandera-mx.png') }}" alt="bandera de mexico"></a></div>
			    </div>
			</div>
		</div>
			...
			<div class="row d-flex align-items-center">
				<div class="col-auto icono-menu-movil">
				 ...
				 <div class="col text-center">
					<a href="{{ url('en') }}"><img class="img-fluid" src="{{ url('/img/Logotipo.png') }}" alt="logo" width="80"></a>
				</div>
				<div class="col-auto menu-derecha-movil">
					<a href="{{ url('en/carrito') }}">
							        	<i class="icon-basket"></i>
							        	<span id="num-items" class="p-0 m-0">{{Cart::content()->count()}}</span>
							        </a>
					<a href="https://api.whatsapp.com/send?phone=5219988453554&text=Buen dia, estoy interesado en unos tours" target="_blank"><i class="icon-whatsapp" aria-hidden="true"></i></a>
				</div>
			</div>
		</div>
	</header>
	...
	<div class="contenedor-menu {{ (Request::path() != 'en') ? 'contenedor-menu-home' : '' }} d-flex align-items-center ocultar-movil">
		<div class="container" >
						...
						<a class="navbar-brand" href="{{ url('/') }}">
					 	 ...
					 	 <div class="collapse navbar-collapse menu {{ (Request::path() != '/') ? 'home' : '' }}" id="navbarSupportedContent">
					    	...
					    	<ul class="nav navbar-nav pull-xs-right">
                                ...
                                <li class="nav-item">
                                    <a style="color: #004580; font-weight: 700;" class="nav-link" href="{{ url('en') }}">HOME <span class="sr-only">(current)</span></a>
                                </li>
                                
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: #004580;     font-weight: 700;">
                                     TOURS & ACTIVITIES
                                    </a>
                                    <div sty class="dropdown-menu sub-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" style="color: #004580;" href="{{route("en/categories",['categorie'=> 'archaeological-sites'])}}">ARCHAEOLOGICAL</a>
                                        <a class="dropdown-item" style="color: #004580;" href="{{route("en/categories",['categorie'=> 'acuaticos'])}}">AQUATIC</a>

                                        {{-- <a class="dropdown-item" style="color: #004580;" href="{{route("yates")}}">YATES</a> --}}
                                        <a class="dropdown-item" style="color: #004580;" href="{{route("en/categories",['categorie'=> 'ventura-park'])}}">VENTURA PARK</a>

                                        <a class="dropdown-item" style="color: #004580;" href="{{route("en/categories",['categorie'=> 'delfines-cancun'])}}">DOLPHINARIS</a>
                                        <a class="dropdown-item" style="color: #004580;" href="{{route("en/categories",['categorie'=> 'selvatica'])}}">SELVATICA</a>

                                        <a class="dropdown-item" style="color: #004580;" href="{{route("en/categories",['categorie'=> 'capitan-hook'])}}">CAPTAIN HOOK</a>
                                 ...
                                 <li class="nav-item dropdown">
                                    ...
                                    <div sty class="dropdown-menu sub-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" style="color: #004580;" href="{{route("en/categories",['categorie'=> 'experiencias-xcaret'])}}">PARQUES XCARET</a>
                                        <a class="dropdown-item" style="color: #004580;" target="_blank" href="https://www.xcaretexperiencias.com/quintanarroenses.php">QUINTANARROENSE</a>



                                </li>
                                <li class="nav-item">
                                    <a style="color: #004580; font-weight: 700;" class="nav-link" href="{{route("en/transportacionGet")}}">TRANSPORTATION</a>
                                </li>
                                <!-- <li class="nav-item">
                                    <a style="color: #004580;" class="nav-link" href="{{route("cars")}}">RENTA DE AUTOS</a>
                                </li> -->
                                <li class="nav-item">
                                    <a style="color: #004580; font-weight: 700;" class="nav-link" href="{{route("en/yates")}}">YATES</a>
                                </li>
                                <li class="nav-item">
                                    <a style="color: #004580; font-weight: 700;" class="nav-link" href="{{ url('en/hotel_flight') }}">HOTEL + FLIGHT<span class="sr-only">(current)</span></a>
                                </li>
                                <li class="nav-item">
                                    <a style="color: #004580; font-weight: 700;" class="nav-link" href="{{ url('en/nosotros') }}">ABOUT <span class="sr-only">(current)</span></a>
                                </li>

							    {{-- <li class="nav-item">
							        <a style="color: #004580;" class="nav-link" href="{{ url('/carrito') }}">
							        	<i class="icon-basket"></i>
							        	<span id="num-items" class="p-0 m-0">{{Cart::content()->count()}}</span>
							        </a>
							    </li> --}}
